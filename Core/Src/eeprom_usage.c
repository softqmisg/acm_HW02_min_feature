...
{
	EE_WriteVariable(VirtAddVarTab[ADD_DUMMY], 0);HAL_Delay(50);
	...
	EE_WriteVariable(VirtAddVarTab[ADD_UTC_OFF],DEFAULT_UTC_OFF);HAL_Delay(50);
	...
	EE_WriteVariable(VirtAddVarTab[ADD_HYS_Temp], DEFAULT_HYS_Temp);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_ENV_TempH], DEFAULT_ENV_TempH);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_ENV_TempL], DEFAULT_ENV_TempL);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_ENV_active], DEFAULT_ENV_active);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_CAM_TempH], DEFAULT_CAM_TempH);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_CAM_TempL], DEFAULT_CAM_TempL);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_CAM_active], DEFAULT_CAM_active);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_CASE_TempH], DEFAULT_CASE_TempH);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_CASE_TempL], DEFAULT_CASE_TempL);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_CASE_active], DEFAULT_CASE_active);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_MB_TempH], DEFAULT_MB_TempH);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_MB_TempL], DEFAULT_MB_TempL);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_MB_active], DEFAULT_MB_active);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_TECIN_TempH], DEFAULT_TECIN_TempH);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_TECIN_TempL], DEFAULT_TECIN_TempL);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_TECIN_active], DEFAULT_TECIN_active);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_TECOUT_TempH], DEFAULT_TECOUT_TempH);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_TECOUT_TempL], DEFAULT_TECOUT_TempL);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_TECOUT_active], DEFAULT_TECOUT_active);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_ADMIN_0],DEFAULT_PASSWORD_ADMIN_0);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_ADMIN_1],DEFAULT_PASSWORD_ADMIN_1);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_ADMIN_2],DEFAULT_PASSWORD_ADMIN_2);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_ADMIN_3], DEFAULT_PASSWORD_ADMIN_3);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_USER_0],DEFAULT_PASSWORD_USER_0);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_USER_1],DEFAULT_PASSWORD_USER_1);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_USER_2],DEFAULT_PASSWORD_USER_2);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PASSWORD_USER_3], DEFAULT_PASSWORD_USER_3);HAL_Delay(50);

	EE_WriteVariable(VirtAddVarTab[ADD_DOOR],DEFAULT_DOOR);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PROFILE_USER],DEFAULT_PROFILE_USER);HAL_Delay(50);
	EE_WriteVariable(VirtAddVarTab[ADD_PROFILE_ADMIN],DEFAULT_PROFILE_ADMIN);HAL_Delay(50);
