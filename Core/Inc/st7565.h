...
#define ST7567_CS_SET	 	HAL_GPIO_WritePin(ST7567_CS_PORT,ST7567_CS_PIN,GPIO_PIN_SET)
#define ST7567_CS_RESET	 	HAL_GPIO_WritePin(ST7567_CS_PORT,ST7567_CS_PIN,GPIO_PIN_RESET)

#define ST7567_CMD_SET	 	HAL_GPIO_WritePin(ST7567_CMD_PORT,ST7567_CMD_PIN,GPIO_PIN_SET)
#define ST7567_CMD_RESET	HAL_GPIO_WritePin(ST7567_CMD_PORT,ST7567_CMD_PIN,GPIO_PIN_RESET)

#define ST7567_SID_SET	 	HAL_GPIO_WritePin(ST7567_SID_PORT,ST7567_SID_PIN,GPIO_PIN_SET)
#define ST7567_SID_RESET 	HAL_GPIO_WritePin(ST7567_SID_PORT,ST7567_SID_PIN,GPIO_PIN_RESET)

#define ST7567_SCLK_SET	 	HAL_GPIO_WritePin(ST7567_SCLK_PORT,ST7567_SCLK_PIN,GPIO_PIN_SET)
#define ST7567_SCLK_RESET	HAL_GPIO_WritePin(ST7567_SCLK_PORT,ST7567_SCLK_PIN,GPIO_PIN_RESET)
///////////////////////////////////////////////////////////////////////////////////////////////////
