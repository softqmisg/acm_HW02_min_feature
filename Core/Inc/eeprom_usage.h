...
#define 	DEFAULT_S2_LED_TYPE					IR_LED
#define 	DEFAULT_S2_LED_DAY_BRIGHTNESS		10
#define 	DEFAULT_S2_LED_DAY_BLINK			0
#define 	DEFAULT_S2_LED_NIGHT_BRIGHTNESS		100
#define 	DEFAULT_S2_LED_NIGHT_BLINK			0
#define 	DEFAULT_S2_LED_ADD_SUNRISE			11
#define 	DEFAULT_S2_LED_ADD_SUNSET			-5
